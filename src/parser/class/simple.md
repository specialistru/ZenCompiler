Следующий файл — `parser/class/simple.c`.

---

### Задача `simple.c` для class:

Парсинг простой декларации класса — заголовок класса с минимальным набором атрибутов.
...
* Парсит заголовок класса с ключевыми словами `CLASS <name> DEFINITION.` и закрытие `ENDCLASS.`.
* Создаёт базовый AST узел класса.
* Пока секции не распаршены, структура готова к расширению.
