Следующий файл — `parser/expression/array_access.c`.

---

### Задача `array_access.c` (expression):

Парсинг доступа к элементам массива или таблицы, например `array[index]`.

---

## Реализация `array_access.c`
...
* Парсит идентификатор массива.
* Проверяет наличие скобок `[ ]`.
* Парсит выражение индекса.
* Формирует AST узел с двумя дочерними: переменная (массив) и индекс.
