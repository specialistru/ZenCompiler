Следующий файл — `parser/expression/variable.c`.

---

### Задача `variable.c` (expression):

Парсинг переменных и ссылок на переменные в выражениях.

---

## Реализация `variable.c`
...
* Парсит идентификатор переменной.
* Поддерживает доступ к полям структуры через `-`.
* Создаёт AST узел переменной с возможными дочерними узлами для полей.
