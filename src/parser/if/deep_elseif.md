Следующий файл — `parser/if/deep_elseif.c`.

---

### Задача `deep_elseif.c`:

Обработка очень вложенных конструкций IF с множественными ELSEIF, рекурсивно парсить вложенные IF внутри ELSEIF.

---

## Реализация `deep_elseif.c`
...
* Рекурсивно парсит ELSEIF, позволяя глубоко вкладывать ELSEIF друг в друга.
* Поддерживает тело ELSEIF с обычными инструкциями.
* Останавливается на ELSE или ENDIF.

---

Жду следующий файл для реализации!
