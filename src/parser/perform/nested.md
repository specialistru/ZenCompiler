Следующий файл — `parser/perform/nested.c`.

---

### Задача `nested.c` для perform:

Парсинг вложенных или составных операторов PERFORM, включая вызовы с параметрами и вызовы форм с диапазонами.
...
* Парсит сложный вызов PERFORM с параметрами USING, CHANGING, TABLES.
* Обрабатывает опцию ON COMMIT.
* Вспомогательная функция парсит списки параметров.
* В случае ошибки возвращает NULL или 0.
