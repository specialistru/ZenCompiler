Следующий файл — `parser/special/authority_check.c`.

---

### Задача `authority_check.c` (special):

Обработка оператора `AUTHORITY-CHECK` в ABAP, который проверяет права доступа пользователя.

---

## Реализация `authority_check.c`
