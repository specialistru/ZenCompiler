Следующий файл — `parser/special/free_create_object.c`.

---

### Задача `free_create_object.c` (special):

Обработка операторов `FREE` и `CREATE OBJECT` в ABAP, отвечающих за освобождение памяти и создание объектов.

---

## Реализация `free_create_object.c`
